...
-   **TypeScript Avançado:** Aprofundando em tipagem complexa e padrões de projeto com TS.
-   **Arquitetura de Software:** Estudando Clean Architecture, DDD e padrões de design para sistemas escaláveis.
-   **Estruturas de Dados e Algoritmos:** Focando em otimização de performance e resolução de problemas complexos.
-   **Next.js:** Explorando as capacidades do App Router, Server Components e Server Actions.

### 💬 Vamos Conectar!

-   **LinkedIn:** [Gabriel de Souza](https://www.linkedin.com/in/bielgsz )
-   **Instagram:** [@ga_souzza](https://www.instagram.com/ga_souzza )

---

⭐️ Do [BielGSouza](https://github.com/BielGSouza )
